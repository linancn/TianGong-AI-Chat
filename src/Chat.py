...
if "wix_callback_url" in st.session_state:
    my_component = components.declare_component(
        "my_component", url="https://test.tiangong.world/callback/"
    )
    my_component1 = components.declare_component(
        "my_component1", url="https://test.tiangong.world/callback/"
    )
...
# st.markdown(st.session_state["wix_return_data"])
